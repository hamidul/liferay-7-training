...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PRICE = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
			BookModelImpl.FINDER_CACHE_ENABLED, BookImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PRICE = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
			BookModelImpl.FINDER_CACHE_ENABLED, BookImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByPrice",
			new String[] { Integer.class.getName() },
			BookModelImpl.PRICE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PRICE = new FinderPath(BookModelImpl.ENTITY_CACHE_ENABLED,
			BookModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Book> findByPrice(int price, int start, int end) {
	 ...
	 */
	@Override
	public Book findByPrice_First(int price,
		OrderByComparator<Book> orderByComparator) throws NoSuchBookException {
		Book book = fetchByPrice_First(price, orderByComparator);
	 ...
	 */
	@Override
	public Book fetchByPrice_First(int price,
		OrderByComparator<Book> orderByComparator) {
		List<Book> list = findByPrice(price, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Book findByPrice_Last(int price,
		OrderByComparator<Book> orderByComparator) throws NoSuchBookException {
		Book book = fetchByPrice_Last(price, orderByComparator);
	 ...
	 */
	@Override
	public Book fetchByPrice_Last(int price,
		OrderByComparator<Book> orderByComparator) {
		...
		List<Book> list = findByPrice(price, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Book[] findByPrice_PrevAndNext(long bookId, int price,
		OrderByComparator<Book> orderByComparator) throws NoSuchBookException {
		...
		try {
			...
			array[0] = getByPrice_PrevAndNext(session, book, price,
					orderByComparator, true);

			array[1] = book;

			array[2] = getByPrice_PrevAndNext(session, book, price,
	...
	protected Book getByPrice_PrevAndNext(Session session, Book book,
		int price, OrderByComparator<Book> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByPrice(int price) {
		for (Book book : findByPrice(price, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_PRICE_PRICE_2 = "book.price = ?";
	...
	public Book updateImpl(Book book) {
		...
		if (!BookModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { bookModelImpl.getPrice() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_PRICE, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PRICE,
				args);
			...
			if ((bookModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { bookModelImpl.getOriginalPrice() };

				finderCache.removeResult(FINDER_PATH_COUNT_BY_PRICE, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PRICE,
					args);

				args = new Object[] { bookModelImpl.getPrice() };
