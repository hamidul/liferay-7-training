...
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.proliferay.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.proliferay.book.model.Book"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.proliferay.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.proliferay.book.model.Book"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.proliferay.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.proliferay.service.util.ServiceProps.get(
	...
	public void resetOriginalValues() {
		...
		bookModelImpl._originalPrice = bookModelImpl._price;

		bookModelImpl._setOriginalPrice = false;
